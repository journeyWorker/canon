...
> How canon's storage rungs (local/hot/cold) and their backends (git/postgres/sqlite/s3) work — configuring canon.yaml's tiers/routing/aging sections, aging records with canon tier age, reading them with canon query, and what canon report does and doesn't surface. Use when editing canon.yaml's tiers/routing/aging config or querying canon's stored records.
