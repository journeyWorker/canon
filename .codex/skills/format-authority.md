...
> How to run canon fmt --check over a consumer repo's artifact-family corpus (ledger/divergences/features/inventory/policy.yaml) and read the violation report it prints. Use when touching crates/canon-fmt or running fmt --check against a corpus.
