---
name: canon-fmt
description: How to run canon format --check over a consumer repo's artifact corpus (ledger/divergences/features/inventory/policy.yaml), what each violation line means, and how to fix it. Use when validating a corpus against canon's format.
---
